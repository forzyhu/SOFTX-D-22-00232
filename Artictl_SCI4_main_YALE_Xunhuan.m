...
%% 系统参数设置
pic_address='F:\mat\测试包\YALE\';%图片的保存地址
% pic_address='F:\mat\测试包\口罩测试图\YALE\';%图片的保存地址
...
Man_num=15;%取多少个人进行训练，图片的命名方式为sx_y，其中x代表不同的人，y代表同一个人的不同图像
Fig_num=11;%每种图片读取的数量
...
Fig_num_end=11;%测试样本结束数值，既到每个人的第几张图片结束进行仿真
...
%         img=Zyh_std(img);
        ...
        %         [x  c img]=Artictl_SCI2_Zyh_Fun_CZYW_2(img);%论文1算法IGCF   -2.8507   17.3508   24.5187    8.8568   -4.6288    8.6714   20.4349   -1.5919
         [img]=Artictl_SCI4_Zyh_Fun_CZYW(img,-2.8507,17.3508,24.5187,8.8568,-4.6288,8.6714,20.4349,-1.5919);%    论文4的算法    (0.2,0.4) YALE推荐  
%         [img]=Artictl_SCI4_Zyh_Fun_CZYW(img,-3.7301,0.4688,4.5717,4.1574,3.4913,-1.0777,-2.2308,-1.8290);%    论文4的算法    (0.2,0.4) YALE推荐
