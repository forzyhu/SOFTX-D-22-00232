...
Train_num_end=18;%训练样本结束数值，既到每个人的第几张图片结束进行训练        改变该值实现训练数量切换
%模拟测试样本参数设置
...
%% 4.3 对SVM进行训练
% SVM参数设置
% cmd = [' -t 2',' -c ',num2str(bestc),' -g ',num2str(bestg)];  % %bestc、bestg是4.1的结果    bestc=16;    bestg=[0.000976562500000000]
