...
%         img=LBP(img);
%         img=Zyh_std(img);
%         [x  c img]=Artictl_SCI2_Zyh_Fun_CZYW_2(img);%97%   [x  c img]的结果是98.5%

        [img]=Artictl_SCI4_Zyh_Fun_CZYW(img,3.5284,2.3740,-4.2648,0.8642,3.0010,-2.4942,15.6236,0.3061);%    论文4的算法    (0.2,0.4)
